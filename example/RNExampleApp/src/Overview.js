    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttons}>
        <Button
          ...
          title={"  Auto Analog/Digital Meter Scanner"}
          color="#0099FF"
          disabled={disabled}
          onPress={() => {
      ...
      <View style={styles.buttons}>
        <Button
          style={styles.buttons}
          title={"  Dial Meter Scanner ALPHA"}
          color="#0099FF"
          disabled={disabled}
          onPress={() => {
